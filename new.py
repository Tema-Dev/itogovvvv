...
def start(message):
    ...
    bot.reply_to(message,
                 '🔥 Привет! Напиши мне любую игру на которую тебе нужна скидка, а я тебе пришлю сайт и там ты её найдёшь(пиши вот так: fc26 Игра)! Чтобы перейти в другие игровые движки то посмотри список команд ниже!')


    commands_text = (
            'кстати, вот мой список моих команд:\n' +
            ...
            '[имя вашей игры и в конце слово Игра] = скидывает сайт cheapshark там где есть ваша игра(если скидка ещё не удалена)\n' +
...
@bot.message_handler(commands=['sendwebsite'])
...
@bot.message_handler(commands=['Gog'])
def Gog(message):
    text2 = (
